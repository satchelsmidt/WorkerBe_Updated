...
function GoalsChild({ navigation }) {
      ...
      <ScrollView>
        <Block style={styles.cardsContainer}>
          ...
          <Block style={styles.addContainer}>
            <TouchableOpacity
              onPress={() => navigation.push('Add Board Member to Goal')}
            >
            ...
            <Block style={styles.boardContainer}>
              <ScrollView
                horizontal={true}
                showsHorizontalScrollIndicator={false}
              >
                {boardMembers.map((boardMember, i) => (
                  <Block style={styles.board} key={`board-member${i}`}>
                    <TouchableOpacity
                      style={styles.boardImageContainer}
                      onPress={() => {
